...
describe("getSearchResults", () => {
  ...
  it("should return canadianism search results when attribute is CANADIANISM", async () => {
    const params = {
      ...mockSearchParams,
      attribute: SearchResultEnum.CANADIANISM,
    }
    const mockCanadianisms = [
      { id: 1, canadianism: "test canadianism", headword: "test1" },
    ]

    vi.mocked(getSearchResultCanadianisms).mockResolvedValue(
      mockCanadianisms as any
    )
  ...
  it("should return usage note search results when attribute is USAGE_NOTE", async () => {
    const params = {
      ...mockSearchParams,
      attribute: SearchResultEnum.USAGE_NOTE,
    }
    const mockUsageNotes = [
      { id: 1, usage: "test usage", headword: "test1", partOfSpeech: "noun" },
    ]

    vi.mocked(getSearchResultUsageNotes).mockResolvedValue(
      mockUsageNotes as any
    )
  ...
  it("should return fist note search results when attribute is FIST_NOTE", async () => {
    const params = {
      ...mockSearchParams,
      attribute: SearchResultEnum.FIST_NOTE,
    }
    const mockFistNotes = [
  ...
  it("should return quotation search results when attribute is QUOTATION", async () => {
    const params = {
      ...mockSearchParams,
      attribute: SearchResultEnum.QUOTATION,
    }
    ...
    vi.mocked(getSearchResultQuotations).mockResolvedValue(
